...
Jan Nowak	11/26/25, 4:16:55 PM	11/26/25, 4:18:08 PM	1m 13s	j.nowak@gmail.com	Organizer";
    ...
    [Fact]
    public async Task ProcessMeetingFilesAsync_ValidTeamsCsvUtf16_Success()
    {
        // Arrange
        var options = new DbContextOptionsBuilder<AppDbContext>()
            .UseInMemoryDatabase(databaseName: Guid.NewGuid().ToString())
        ...
        // Create UTF-16 LE encoded Teams CSV with BOM
        var csvContent = @"1. Summary
Meeting title	Meeting with Jan Nowak
Attended participants	1
Start time	11/26/25, 4:16:54 PM
...
Jan Nowak	11/26/25, 4:16:55 PM	11/26/25, 4:18:08 PM	1m 13s	j.nowak@gmail.com	Organizer";
        ...
        var file = CreateFormFileUtf16(csvContent, "teams_meeting_utf16.csv", "text/csv");
        var files = new List<IFormFile> { file };
    ...
    private static IFormFile CreateFormFileUtf16(string content, string fileName, string contentType)
    {
        var encoding = System.Text.Encoding.Unicode; // UTF-16 LE
